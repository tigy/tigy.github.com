...
var imgpath='assets/images/',imgpaths=[],colors=['black','blue','green','orange','purple','red','yellow'];
...
function md_onmouseup(e){
	...
	if(isBall){
		...
		searchPath(x,y,spaceValues[endP],[],0);
		if(pathXYs.length>=4){
			replaceBlank(endP, currBall.p);
			currBall.stopAnimate();
...
Skin={
	'data':{
		'classical':['','']
		,'girl':['assets/images/bg-girl.jpg','assets/images/grid-purple.gif']
		,'mdb':['assets/images/bg-mdb.jpg','assets/images/grid-white.gif']
		,'spring':['assets/images/bg-spring.jpg','assets/images/grid-grass.gif']
	}
	,'active':'classical'
	,'ready':false
