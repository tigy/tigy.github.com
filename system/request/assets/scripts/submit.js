 ...
 */
Ajax.submit = function(form, onsuccess, onerror, timeouts, oncomplete) {
	...
	return Ajax[/^post$/i.test(form.method) ? "post" : "get"](form.action || location.href, Request.formParam(form), onsuccess, onerror, timeouts, oncomplete);
};
